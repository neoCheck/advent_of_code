#!/usr/bin/env python
DAY_2_INPUT = """Game 1: 7 blue, 6 green, 3 red; 3 red, 5 green, 1 blue; 1 red, 5 green, 8 blue; 3 red, 1 green, 5 blue
...
def parse_info(game_input: str):
    ...
    return game_id, cube_max_values
...
if __name__ == "__main__":
    info_list = [parse_info(line) for line in DAY_2_INPUT.split("\n")]

    eligible_games = [game for game in info_list if check_minimum_cubes(game)]
    result = sum([game_id for game_id, cubes in eligible_games])
    print(result)
