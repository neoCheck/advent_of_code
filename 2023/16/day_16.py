...
def run_beam(contraption_layout: list[list[str]]) -> list[tuple[int, int]]:
    beam_course = []
    beam_cache = []
    new_beams = [Beam(contraption_layout, 0, 0, BeamDirection.RIGHT, beam_cache)]
...
def main():
    ...
    beam_course = run_beam(contraption_layout)
    result = len(set(beam_course))
